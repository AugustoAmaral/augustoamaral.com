...
export const ui = {
  en: {
    ...
    'experiences.h1': 'Five jobs, eight years, told as a story.',
    ...
    'privacy.s02b.title': '§02b — LIZ CHROME EXTENSION',
    'privacy.s02b.body': 'The Liz browser extension injects a management panel into WhatsApp Web so the clinic can control the bot without leaving the conversation. It uses the "storage" permission to save local preferences and communicates exclusively with liz.augustoamaral.com to fetch patient status, settings, and connection state. No personal data is collected, stored, or transmitted to third parties. The extension does not read, intercept, or store any WhatsApp message content.',
  ...
  pt: {
    ...
    'experiences.h1': 'Cinco empregos, oito anos, contados como uma história.',
    ...
    'privacy.s02b.title': '§02b — EXTENSÃO CHROME DA LIZ',
    'privacy.s02b.body': 'A extensão de navegador da Liz injeta um painel de gerenciamento no WhatsApp Web para que o consultório controle o bot sem sair da conversa. Ela usa a permissão "storage" para salvar preferências locais e se comunica exclusivamente com liz.augustoamaral.com para buscar status de pacientes, configurações e estado de conexão. Nenhum dado pessoal é coletado, armazenado ou transmitido a terceiros. A extensão não lê, intercepta ou armazena conteúdo de mensagens do WhatsApp.',
